...
(function () {
    ...
    // Force open/closed controls are Settings diagnostics only — never in demo
    // (demo drives live reed state; "Forced open/closed" would look wrong).
    const developmentMode =
        window.SCCS?.developmentMode === true && window.SCCS?.demoMode !== true;
